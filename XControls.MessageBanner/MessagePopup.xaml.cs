...
namespace XControls.MessageBanner
{
    ...
    internal partial class MessagePopup : Window
    {
        ...
        {
            if (sender == OkButton)
                Result = MessageBanner.DialogResult.Ok;
            else if (sender == YesButton)
                Result = MessageBanner.DialogResult.Yes;
            else if (sender == NoButton)
                Result = MessageBanner.DialogResult.No;
            else if (sender == CancelButton)
                Result = MessageBanner.DialogResult.Cancel;
            else
                Result = MessageBanner.DialogResult.None;
            Close();
